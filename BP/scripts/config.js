...
export const CONFIG = {
  ...
  GATES: {
    ...
    // arena 33x12x33 construída localmente, deslocada do jogador
    ARENA: {
      SIZE: 33,
      HEIGHT: 12,
      WALL_HEIGHT: 8,
      ...
      BLOCKS_BY_RANK: {
        E: {
          ...
          floorTrim: "minecraft:polished_blackstone_bricks",
          wall: "minecraft:obsidian",
          wallAccent: "minecraft:crying_obsidian",
        ...
        D: {
          ...
          floorTrim: "minecraft:chiseled_polished_blackstone",
          wall: "minecraft:obsidian",
          wallAccent: "minecraft:crying_obsidian",
          lamp: "minecraft:soul_lantern",
          accentRows: [2, 5],
          accentEvery: 5,
        },
        C: {
          floor: "minecraft:blackstone",
          floorTrim: "minecraft:gilded_blackstone",
        ...
        B: {
          floor: "minecraft:gilded_blackstone",
          floorTrim: "minecraft:chiseled_polished_blackstone",
          wall: "minecraft:obsidian",
          wallAccent: "minecraft:shroomlight",
          lamp: "minecraft:soul_lantern",
          accentRows: [2, 5, 7],
          accentEvery: 4,
        },
        A: {
          floor: "minecraft:polished_blackstone_bricks",
          floorTrim: "minecraft:moss_block",
          wall: "minecraft:obsidian",
          wallAccent: "minecraft:crying_obsidian",
          lamp: "minecraft:shroomlight",
          accentRows: [1, 4, 7],
