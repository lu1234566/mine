...
**Estado atual: Fase 8C+ (v0.8.12).** Fases 1–7 completas (despertar, stats/HUD/mana, missão diária + Zona de Penalidade, Devorar/traços, evolução em 2 estágios, Exército de Sombras, Portais E–S) + Fase 8: **habilidades ativas** via Grimório (Impulso, Golpe Fantasma, Ocultação, Dreno Sombrio, Clarividência), **Rupturas** de chaves envelhecidas + Portal Vermelho, **Fusão de sombras** com tier Elite e nomes próprios, texturas por tier/rank para sombras e Guardião, Poção de XP do Sistema e arenas de portal E-A construídas por rank. Checklists de teste por fase: `docs/CHECKLISTS.md`.
